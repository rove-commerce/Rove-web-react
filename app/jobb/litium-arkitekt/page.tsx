...
export default function Home() {
	return (
		<>
			<PageHeader>Litium-arkitekt (som vill vara med från början och bygga bolag)</PageHeader>
				...
				<div className="wrapper">
					<div className="inner-wrapper">
						<div className="wysiwyg" style={{ maxWidth: "687px" }}>
							...
							<p>
								I rollen som Arkitekt arbetar du för att vi ska leverera tekniska lösningar i världsklass som ger våra kunder ett stort värde.
							...
							<ul>
								<li>Är en erfaren .Net-arkitekt (med inte är rädd för att koda själv)</li>
								...
								<li>Gärna hjälper till i säljet som pre-sale</li>
