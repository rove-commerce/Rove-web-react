...
export default function Home() {
	return (
		<>
			{/* Rove Methods */}
			<div id="methods" className="bg-blue">
					...
					<div className="inner-wrapper">
						...
						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-white mb-12">
							...
							<p className="text-white text-16 mb-2">
								Med Rove Kundresan kartlägger vi hur era kunder vill agera under sin kundresa eller köpresa, hur de tar köpbeslut och hur ni
								bygger lojalitet.
							</p>
						</div>
						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-white mb-12">
							<p className="text-white text-32 mb-4 font-semibold">Upphandling</p>
							<p className="text-white text-16 mb-2">
								Med Rove Upphandling leder vi upphandling av system och/eller leverantör av e-handel, PIM eller verktyg för digital
								marknadsföring utifrån vår upphandlingsmetod, från krav till slutlig rekommendation och beslut.
							</p>
						</div>
						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-white">
							...
							<p className="text-white text-16 mb-2">
								I Rove Förstudie tar vi fram mål och krav på system och/eller leverantör som ger framgångsrika projekt, med de bästa
								förutsättningarna för att nå era mål och ett lyckat internt införande.
							</p>
						</div>
					</div>
				</div>
			...
			{/* Rove Build */}
			<div id="build" className="bg-orange">
				<div className="wrapper py-16">
					<div className="inner-wrapper">
						...
						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-blue mb-12">
							<p className="text-blue text-32 mb-4 font-semibold">Litium e-handel och PIM</p>
						...
						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-blue mb-12">
							<p className="text-blue text-32 mb-4 font-semibold">Litium Apps och Add-ons</p>
							<p className="text-black text-16 mb-2">
						...
						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-blue mb-12">
							<p className="text-blue text-32 mb-4 font-semibold">Headless e-handel</p>
							<p className="text-black text-16 mb-2">
								Implementation av frontend och backend till headless e-handel utifrån era affärsmål - hela vägen från UX-design till
								API-strategi, systemutveckling, integrationer, test & kvalitetssäkring, interna processer till utrullning och
								produktionssättning.
							</p>
						</div>
						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-blue mb-12">
							<p className="text-blue text-32 mb-4 font-semibold">Headless CMS</p>
							<p className="text-black text-16 mb-2">
								Implementation av headless CMS utifrån er kanalstrategi och marknadsprocess. Vi arbetar bl.a. med Contentful och Storyblok.
							</p>
						</div>
						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-blue mb-12">
							<p className="text-blue text-32 mb-4 font-semibold">Införa HubSpot</p>
							<p className="text-black text-16 mb-2">
			...
			{/* Rove Advisory */}
			<div id="advisory" className="bg-white">
				<div className="wrapper py-16">
					<div className="inner-wrapper">
						<div className="w-3/4 laptop:w-2/5 mb-8">
						...
						<div className="text-black text-24 mb-8">
							<p>Rove Advisory är rådgivnings- och ledarskapstjänster av erfarna och affärsdrivna ledare och strateger.</p>
						</div>

						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-blue mb-12">
							<p className="text-blue text-32 mb-4 font-semibold">Projektledning</p>
							<p className="text-black text-16 mb-2">
								Med tjänsten Rove Projektledning får ni hjälp med hands-on projektledning från start till mål av en erfaren och affärsdriven
								projektledare.
							</p>
						</div>
						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-blue mb-12">
							<p className="text-blue text-32 mb-4 font-semibold">Styrgruppsarbete</p>
							<p className="text-black text-16 mb-2">
								Med tjänsten Rove Styrgruppsarbete får ni hjälp med deltagande som en neutral part i en styrgrupp för projektet eller att följa
								upp och kvalitetssäkra externa leveranser eller interna processer.
							</p>
						</div>
						<div className="laptop:px-4 py-1 border-t laptop:border-l laptop:border-t-0 border-blue">
							...
							<p className="text-black text-16 mb-2">Strategisk och hands-on rådgivning för e-handel, PIM och digital marknadsföring.</p>
						</div>
					</div>
				</div>
			</div>
